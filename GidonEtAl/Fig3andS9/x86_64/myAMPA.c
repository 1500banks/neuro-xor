...
#define EPSP EPSP__myAMPA 
#define play play__myAMPA 
#define remove_play remove_play__myAMPA 
...
#define get_factor get_factor_myAMPA
 extern double get_factor( double , double );
 /* declare global and static user variables */
#define mg_dep mg_dep_myAMPA
 double mg_dep = 3.57;
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 myAMPA /Users/ethanbanks/Documents/GitHub/neuro-xor/GidonEtAl/_mod/myAMPA.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/ethanbanks/Documents/GitHub/neuro-xor/GidonEtAl/_mod/myAMPA.mod";
static const char* nmodl_file_text = 
  "\n"
  "COMMENT\n"
  "\n"
