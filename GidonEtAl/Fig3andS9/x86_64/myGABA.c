...
#define nrn_init _nrn_init__myGABA
#define _nrn_initial _nrn_initial__myGABA
#define nrn_cur _nrn_cur__myGABA
#define _nrn_current _nrn_current__myGABA
#define nrn_jacob _nrn_jacob__myGABA
#define nrn_state _nrn_state__myGABA
#define _net_receive _net_receive__myGABA 
#define EPSP EPSP__myGABA 
#define play play__myGABA 
#define remove_play remove_play__myGABA 
#define state state__myGABA 
...
#define get_factor get_factor_myGABA
 extern double get_factor( double , double );
 /* declare global and static user variables */
#define mg_dep mg_dep_myGABA
 double mg_dep = 3.57;
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 myGABA /Users/ethanbanks/Documents/GitHub/neuro-xor/GidonEtAl/_mod/myGABA.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/ethanbanks/Documents/GitHub/neuro-xor/GidonEtAl/_mod/myGABA.mod";
static const char* nmodl_file_text = 
  "\n"
  "COMMENT\n"
  "\n"
  ...
  "\n"
  ":::INCLUDE \"ISyn.inc\"\n"
  ":::realpath /Users/ethanbanks/Documents/GitHub/neuro-xor/GidonEtAl/_mod/ISyn.inc\n"
  "\n"
  "NEURON {\n"
  ...
  ":::INCLUDE \"IUtils.inc\"\n"
  ":::realpath /Users/ethanbanks/Documents/GitHub/neuro-xor/GidonEtAl/_mod/IUtils.inc\n"
  "NEURON{\n"
